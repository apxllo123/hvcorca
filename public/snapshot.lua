...
newModule("App", "ModuleScript", "hvcorca.App", "hvcorca", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
newModule("Acrylic", "ModuleScript", "hvcorca.components.Acrylic", "hvcorca.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
newModule("scale-context", "ModuleScript", "hvcorca.context.scale-context", "hvcorca.context", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
newModule("flipper-hooks", "ModuleScript", "hvcorca.hooks.common.flipper-hooks", "hvcorca.hooks.common", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local exports = {}
...
newModule("flight", "LocalScript", "hvcorca.jobs.character.flight", "hvcorca.jobs.character", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local _flipper = TS.import(script, TS.getModule(script, "@rbxts", "flipper").src)
local GroupMotor = _flipper.GroupMotor
...
newModule("freecam", "ModuleScript", "hvcorca.jobs.helpers.freecam", "hvcorca.jobs.helpers", function () return setfenv(function() ------------------------------------------------------------------------
-- Freecam
...
newModule("hide", "LocalScript", "hvcorca.jobs.players.hide", "hvcorca.jobs.players", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Players = TS.import(script, TS.getModule(script, "@rbxts", "services")).Players
...
newModule("dashboard.action", "ModuleScript", "hvcorca.store.actions.dashboard.action", "hvcorca.store.actions", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
...
newModule("dashboard.model", "ModuleScript", "hvcorca.store.models.dashboard.model", "hvcorca.store.models", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local DashboardPage
do
	local _inverse = {}
...
local function persistentState(name, selector, defaultValue)
	local _exitType, _returns = TS.try(function()
		...
		return TS.TRY_RETURN, { HttpService:JSONDecode(serializedState) }
	end, function(err)
...
newModule("dashboard.reducer", "ModuleScript", "hvcorca.store.reducers.dashboard.reducer", "hvcorca.store.reducers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)
local Rodux = TS.import(script, TS.getModule(script, "@rbxts", "rodux").src)
...
local darkTheme = {
	...
	preview = {
		...
		background = {
			color = ColorSequence.new(hex("#111111")),
		},
		accent = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#8B0000")), ColorSequenceKeypoint.new(0.5, hex("#CC2929")), ColorSequenceKeypoint.new(1, hex("#FF6666")) }),
			rotation = 25,
		},
	},
	navbar = {
		...
		transparency = 0,
		accentGradient = {
			color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#8B0000")), ColorSequenceKeypoint.new(0.25, hex("#CC2929")), ColorSequenceKeypoint.new(0.5, hex("#E83A3A")), ColorSequenceKeypoint.new(0.75, hex("#CC2929")), ColorSequenceKeypoint.new(1, hex("#8B0000")) }),
		},
	...
	apps = {
		players = {
			...
			avatar = {
				background = hex("#0D0D0D"),
				gradient = {
					color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex("#CC2929")), ColorSequenceKeypoint.new(1, hex("#CC2929")) }),
					rotation = 25,
				},
				transparency = 0,
			},
...
newModule("array-util", "ModuleScript", "hvcorca.utils.array-util", "hvcorca.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
newModule("Clock", "ModuleScript", "hvcorca.views.Clock", "hvcorca.views", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = require(script.Parent.Parent.include.RuntimeLib)
local exports = {}
...
local function Navbar()
	...
	local alpha = useSpring(PAGE_TO_INDEX[page] / TAB_COUNT, {
		frequency = 3.9,
		dampingRatio = 0.76,
	})
	local _attributes = {
...
return {
 ...
 end, newEnv("hvcorca.views.Navbar.constants"))() end)
...
newModule("Promise", "ModuleScript", "hvcorca.include.Promise", "hvcorca.include", function () return setfenv(function() --[[
...
newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src", "hvcorca.include.node_modules.@rbxts.flipper", function () return setfenv(function() local Flipper = {
...
return Flipper end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src"))() end)

newModule("BaseMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.BaseMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return Instant end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Instant"))() end)

newModule("Linear", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.Linear", "hvcorca.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local Linear = {}
...
return Linear end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Linear"))() end)

newModule("Signal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.Signal", "hvcorca.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local Connection = {}
...
return Signal end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Signal"))() end)

newModule("SingleMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.SingleMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local BaseMotor = require(script.Parent.BaseMotor)
...
return Spring end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Spring"))() end)

newModule("isMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.isMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () return setfenv(function() local function isMotor(value)
...
return isMotor end, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.isMotor"))() end)

newInstance("typings", "Folder", "hvcorca.include.node_modules.@rbxts.flipper.typings", "hvcorca.include.node_modules.@rbxts.flipper")

newModule("make", "ModuleScript", "hvcorca.include.node_modules.@rbxts.make", "hvcorca.include.node_modules.@rbxts", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
--[[
	*
...
return Object
 end, newEnv("hvcorca.include.node_modules.@rbxts.object-utils"))() end)

newInstance("roact", "Folder", "hvcorca.include.node_modules.@rbxts.roact", "hvcorca.include.node_modules.@rbxts")

newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src", "hvcorca.include.node_modules.@rbxts.roact", function () return setfenv(function() --[[
...
return Roact end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src"))() end)

newModule("Binding", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Binding", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local createSignal = require(script.Parent.createSignal)
...
return BindingInternalApi end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Binding"))() end)

newModule("Component", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Component", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return Component end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Component"))() end)

newModule("ComponentLifecyclePhase", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return ComponentLifecyclePhase end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase"))() end)

newModule("Config", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Config", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Config end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Config"))() end)

newModule("ElementKind", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ElementKind", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return ElementKind end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ElementKind"))() end)

newModule("ElementUtils", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ElementUtils", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local Symbol = require(script.Parent.Symbol)
...
return ElementUtils end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ElementUtils"))() end)

newModule("GlobalConfig", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.GlobalConfig", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
	Exposes a single instance of a configuration as Roact's GlobalConfig.
]]

local Config = require(script.Parent.Config)

return Config.new() end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.GlobalConfig"))() end)

newModule("Logging", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Logging", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Logging end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Logging"))() end)

newModule("None", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.None", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

-- Marker used to specify that the value is nothing, because nil cannot be
-- stored in tables.
local None = Symbol.named("None")

return None end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.None"))() end)

newModule("NoopRenderer", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.NoopRenderer", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return NoopRenderer end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.NoopRenderer"))() end)

newModule("Portal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Portal", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)

local Portal = Symbol.named("Portal")

return Portal end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Portal"))() end)
...
newModule("Change", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Change", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Children end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Children"))() end)

newModule("Event", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Event", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers", function () return setfenv(function() --[[
...
return Ref end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Ref"))() end)

newModule("PureComponent", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PureComponent", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return PureComponent end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PureComponent"))() end)

newModule("RobloxRenderer", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.RobloxRenderer", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return SingleEventManager end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.SingleEventManager"))() end)

newModule("Symbol", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Symbol", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Symbol end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Symbol"))() end)

newModule("Type", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Type", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return Type end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Type"))() end)

newModule("assertDeepEqual", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.assertDeepEqual", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return assertDeepEqual end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.assertDeepEqual"))() end)

newModule("assign", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.assign", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local None = require(script.Parent.None)
...
return assign end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.assign"))() end)

newModule("createContext", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createContext", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Symbol = require(script.Parent.Symbol)
...
return createElement end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createElement"))() end)

newModule("createFragment", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createFragment", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local ElementKind = require(script.Parent.ElementKind)
local Type = require(script.Parent.Type)
...
return createFragment end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createFragment"))() end)

newModule("createReconciler", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createReconciler", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local Type = require(script.Parent.Type)
local ElementKind = require(script.Parent.ElementKind)
...
return createReconcilerCompat end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createReconcilerCompat"))() end)

newModule("createRef", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createRef", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createRef end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createRef"))() end)

newModule("createSignal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createSignal", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return createSpy end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createSpy"))() end)

newModule("forwardRef", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.forwardRef", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local assign = require(script.Parent.assign)
...
return forwardRef end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.forwardRef"))() end)

newModule("getDefaultInstanceProperty", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return getDefaultInstanceProperty end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty"))() end)

newModule("internalAssert", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.internalAssert", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local function internalAssert(condition, message)
	if not condition then
		error(message .. " (This is probably a bug in Roact!)", 3)
	end
end

return internalAssert end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.internalAssert"))() end)

newModule("invalidSetStateMessages", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.invalidSetStateMessages", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return invalidSetStateMessages end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.invalidSetStateMessages"))() end)

newModule("oneChild", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.oneChild", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() --[[
...
return oneChild end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.oneChild"))() end)

newModule("strict", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.strict", "hvcorca.include.node_modules.@rbxts.roact.src", function () return setfenv(function() local function strict(t, name)
...
return strict end, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.strict"))() end)

newInstance("roact-hooked", "Folder", "hvcorca.include.node_modules.@rbxts.roact-hooked", "hvcorca.include.node_modules.@rbxts")

newModule("out", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-hooked.out", "hvcorca.include.node_modules.@rbxts.roact-hooked", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
local TS = _G[script]
local exports = {}
...
newModule("are-deps-equal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-hooked.out.utils.are-deps-equal", "hvcorca.include.node_modules.@rbxts.roact-hooked.out.utils", function () return setfenv(function() -- Compiled with roblox-ts v1.2.7
...
newModule("out", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
local exports = {}
...
newModule("context", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.components.context", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.components", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
local Roact = TS.import(script, TS.getModule(script, "@rbxts", "roact").src)
...
newModule("shallow-equal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.helpers.shallow-equal", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.helpers", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
newModule("use-dispatch", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.hooks.use-dispatch", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.hooks", function () return setfenv(function() -- Compiled with roblox-ts v1.2.3
local TS = _G[script]
...
newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src", "hvcorca.include.node_modules.@rbxts.rodux", function () return setfenv(function() local Store = require(script.Store)
...
return Signal end, newEnv("hvcorca.include.node_modules.@rbxts.rodux.src.Signal"))() end)

newModule("Store", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src.Store", "hvcorca.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() local RunService = game:GetService("RunService")
...
return prettyPrint end, newEnv("hvcorca.include.node_modules.@rbxts.rodux.src.prettyPrint"))() end)

newModule("thunkMiddleware", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src.thunkMiddleware", "hvcorca.include.node_modules.@rbxts.rodux.src", function () return setfenv(function() --[[
