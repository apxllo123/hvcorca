...
newModule("App", "ModuleScript", "hvcorca.App", "hvcorca", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
newModule("Acrylic", "ModuleScript", "hvcorca.components.Acrylic", "hvcorca.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
newModule("scale-context", "ModuleScript", "hvcorca.context.scale-context", "hvcorca.context", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
newInstance("common", "Folder", "hvcorca.hooks.common", "hvcorca.hooks")

newModule("flipper-hooks", "ModuleScript", "hvcorca.hooks.common.flipper-hooks", "hvcorca.hooks.common", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local exports = {}\
...
newModule("flight", "LocalScript", "hvcorca.jobs.character.flight", "hvcorca.jobs.character", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local _flipper = TS.import(script, TS.getModule(script, \"@rbxts\", \"flipper\").src)\
local GroupMotor = _flipper.GroupMotor\
...
newModule("freecam", "ModuleScript", "hvcorca.jobs.helpers.freecam", "hvcorca.jobs.helpers", function () local fn = assert(loadstring("------------------------------------------------------------------------\
-- Freecam\
...
newModule("hide", "LocalScript", "hvcorca.jobs.players.hide", "hvcorca.jobs.players", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Players = TS.import(script, TS.getModule(script, \"@rbxts\", \"services\")).Players\
...
newInstance("actions", "Folder", "hvcorca.store.actions", "hvcorca.store")

newModule("dashboard.action", "ModuleScript", "hvcorca.store.actions.dashboard.action", "hvcorca.store.actions", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
...
newModule("dashboard.model", "ModuleScript", "hvcorca.store.models.dashboard.model", "hvcorca.store.models", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local DashboardPage\
do\
\9local _inverse = {}\
...
\9[DashboardPage.Misc] = 3,\
\9[DashboardPage.Options] = 4,\
}\
local PAGE_TO_ICON = {\
...
newModule("dashboard.reducer", "ModuleScript", "hvcorca.store.reducers.dashboard.reducer", "hvcorca.store.reducers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
\9\9},\
\9\9background = {\
\9\9\9color = ColorSequence.new(hex(\"#111111\")),\
\9\9},\
\9\9accent = {\
\9\9\9color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex(\"#8B0000\")), ColorSequenceKeypoint.new(0.5, hex(\"#CC2929\")), ColorSequenceKeypoint.new(1, hex(\"#FF6666\")) }),\
\9\9\9rotation = 25,\
\9\9},\
\9},\
\9navbar = {\
...
\9\9background = hex(\"#111111\"),\
\9\9transparency = 0,\
\9\9accentGradient = {\
\9\9\9color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex(\"#8B0000\")), ColorSequenceKeypoint.new(0.25, hex(\"#CC2929\")), ColorSequenceKeypoint.new(0.5, hex(\"#E83A3A\")), ColorSequenceKeypoint.new(0.75, hex(\"#CC2929\")), ColorSequenceKeypoint.new(1, hex(\"#8B0000\")) }),\
\9\9},\
\9\9dropshadow = hex(\"#111111\"),\
...
\9\9\9\9color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex(\"#8B0000\")), ColorSequenceKeypoint.new(0.5, hex(\"#CC2929\")), ColorSequenceKeypoint.new(1, hex(\"#FF6666\")) }),\
\9\9\9\9rotation = 25,\
\9\9\9},\
\9\9\9transparency = 0,\
...
\9\9\9acrylic = false,\
\9\9\9foreground = hex(\"#ffffff\"),\
\9\9\9background = hex(\"#111111\"),\
\9\9\9transparency = 0,\
\9\9\9dropshadow = hex(\"#111111\"),\
\9\9\9dropshadowTransparency = 0.3,\
\9\9\9avatar = {\
\9\9\9\9background = hex(\"#0D0D0D\"),\
\9\9\9\9gradient = {\
\9\9\9\9\9color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex(\"#8B0000\")), ColorSequenceKeypoint.new(0.5, hex(\"#CC2929\")), ColorSequenceKeypoint.new(1, hex(\"#FF6666\")) }),\
...
\9\9\9},\
\9\9\9highlight = {\
\9\9\9\9flight = hex(\"#CC2929\"),\
\9\9\9\9walkSpeed = hex(\"#E83A3A\"),\
\9\9\9\9jumpHeight = hex(\"#FF6666\"),\
\9\9\9\9refresh = hex(\"#CC2929\"),\
\9\9\9\9ghost = hex(\"#FF4444\"),\
\9\9\9\9godmode = hex(\"#8B0000\"),\
\9\9\9\9freecam = hex(\"#E83A3A\"),\
\9\9\9},\
\9\9},\
\9\9server = {\
\9\9\9outlined = true,\
\9\9\9acrylic = false,\
\9\9\9foreground = hex(\"#ffffff\"),\
\9\9\9background = hex(\"#CC2929\"),\
\9\9\9transparency = 0,\
\9\9\9dropshadow = hex(\"#CC2929\"),\
\9\9\9dropshadowTransparency = 0.3,\
\9\9\9rejoinButton = {\
\9\9\9\9outlined = true,\
\9\9\9\9foreground = hex(\"#ffffff\"),\
\9\9\9\9background = hex(\"#CC2929\"),\
\9\9\9\9accent = hex(\"#111111\"),\
\9\9\9\9foregroundTransparency = 0,\
\9\9\9\9backgroundTransparency = 0,\
\9\9\9},\
\9\9\9switchButton = {\
...
\9\9\9\9background = hex(\"#0D0D0D\"),\
\9\9\9\9gradient = {\
\9\9\9\9\9color = ColorSequence.new({ ColorSequenceKeypoint.new(0, hex(\"#CC2929\")), ColorSequenceKeypoint.new(1, hex(\"#CC2929\")) }),\
\9\9\9\9\9rotation = 25,\
\9\9\9\9},\
\9\9\9\9transparency = 0,\
\9\9\9},\
...
\9\9\9},\
\9\9\9highlight = {\
\9\9\9\9teleport = hex(\"#CC2929\"),\
\9\9\9\9hide = hex(\"#8B0000\"),\
\9\9\9\9kill = hex(\"#FF4444\"),\
\9\9\9\9spectate = hex(\"#E83A3A\"),\
\9\9\9},\
\9\9\9playerButton = {\
\9\9\9\9outlined = true,\
\9\9\9\9accent = hex(\"#CC2929\"),\
...
newModule("array-util", "ModuleScript", "hvcorca.utils.array-util", "hvcorca.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
newModule("Clock", "ModuleScript", "hvcorca.views.Clock", "hvcorca.views", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local exports = {}\
...
local NAVBAR_SIZE = _constants.NAVBAR_SIZE\
...
\9\9return state.dashboard.isOpen\
\9end)\
\9local alpha = useSpring(PAGE_TO_INDEX[page] / TAB_COUNT, {\
\9\9frequency = 3.9,\
...
\9\9\9\9return getColorInSequence(theme.accentGradient.color, a + 0.1)\
\9\9\9end),\
\9\9}),\
\9\9Roact.createElement(Fill, {\
\9\9\9color = theme.background,\
...
\9\9\9size = px(100, 56),\
\9\9\9position = alpha:map(function(a)\
\9\9\9\9return scale(math.round(a * 1000) / 1000, 0)\
\9\9\9end),\
\9\9\9clipsDescendants = true,\
\9\9}, {\
\9\9\9Roact.createElement(\"Frame\", {\
...
\9\9\9\9\9return scale(-5 * (math.round(a * 1000) / 1000), 0)\
\9\9\9\9end),\
...
\9local setHovered = _binding[2]\
\9local icon = PAGE_TO_ICON[page]\
\9local transparency = useSpring(isActive and 0 or (isHovered and 0.5 or 0.75), {})\
\9return Roact.createElement(\"TextButton\", {\
\9\9Text = \"\",\
\9\9AutoButtonColor = false,\
\9\9Active = not isActive,\
\9\9Size = TAB_SIZE,\
\9\9Position = scale(PAGE_TO_INDEX[page] / TAB_COUNT, 0),\
\9\9BackgroundTransparency = 1,\
\9\9[Roact.Event.Activated] = function()\
...
\9\9end,\
\9}, {\
\9\9icon ~= nil and (Roact.createElement(\"ImageLabel\", {\
\9\9\9Image = icon,\
\9\9\9ImageColor3 = theme.foreground,\
\9\9\9ImageTransparency = transparency,\
\9\9\9Size = px(36, 36),\
\9\9\9Position = scale(0.5, 0.5),\
\9\9\9AnchorPoint = Vector2.new(0.5, 0.5),\
\9\9\9BackgroundTransparency = 1,\
\9\9})) or (Roact.createElement(TerminalIcon, {\
\9\9\9color = theme.foreground,\
\9\9\9transparency = transparency,\
\9\9})),\
\9})\
...
newModule("TerminalIcon", "ModuleScript", "hvcorca.views.Navbar.TerminalIcon", "hvcorca.views.Navbar", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out).hooked\
local _udim2 = TS.import(script, script.Parent.Parent.Parent, \"utils\", \"udim2\")\
...
\9\9BackgroundTransparency = 1,\
\9}, {\
\9\9PromptUpper = Roact.createElement(\"Frame\", {\
\9\9\9Size = px(15, 3),\
\9\9\9Position = px(14.9, 13.9),\
\9\9\9AnchorPoint = Vector2.new(0.5, 0.5),\
\9\9\9Rotation = 28.3,\
\9\9\9BackgroundColor3 = color,\
\9\9\9BackgroundTransparency = transparency,\
\9\9\9BorderSizePixel = 0,\
\9\9}),\
\9\9PromptLower = Roact.createElement(\"Frame\", {\
\9\9\9Size = px(15, 3),\
\9\9\9Position = px(14.9, 20.9),\
\9\9\9AnchorPoint = Vector2.new(0.5, 0.5),\
\9\9\9Rotation = -28.3,\
\9\9\9BackgroundColor3 = color,\
\9\9\9BackgroundTransparency = transparency,\
\9\9\9BorderSizePixel = 0,\
\9\9}),\
\9\9Cursor = Roact.createElement(\"Frame\", {\
\9\9\9Size = px(9, 3),\
\9\9\9Position = px(23.9, 25.4),\
\9\9\9AnchorPoint = Vector2.new(0.5, 0.5),\
\9\9\9BackgroundColor3 = color,\
\9\9\9BackgroundTransparency = transparency,\
\9\9\9BorderSizePixel = 0,\
...
", '@'.."hvcorca.views.Navbar.TerminalIcon")) setfenv(fn, newEnv("hvcorca.views.Navbar.TerminalIcon")) return fn() end)

newModule("constants", "ModuleScript", "hvcorca.views.Navbar.constants", "hvcorca.views.Navbar", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local px = TS.import(script, script.Parent.Parent.Parent, \"utils\", \"udim2\").px\
local TAB_COUNT = 5\
local TAB_WIDTH = 100\
local TAB_SIZE = px(TAB_WIDTH, 56)\
local NAVBAR_SIZE = px(TAB_COUNT * TAB_WIDTH, 56)\
return {\
\9TAB_COUNT = TAB_COUNT,\
\9TAB_WIDTH = TAB_WIDTH,\
\9TAB_SIZE = TAB_SIZE,\
\9NAVBAR_SIZE = NAVBAR_SIZE,\
}\
", '@'.."hvcorca.views.Navbar.constants")) setfenv(fn, newEnv("hvcorca.views.Navbar.constants")) return fn() end)
...
\9TS.try(function()\
\9\9local content = TS.await(http.get(cmd.url))\
\9\9local _binding = loadstring(content, \"@\" .. cmd.name)\
\9\9local fn = _binding[1]\
\9\9local err = _binding[2]\
\9\9local _arg1 = \"loadstring failed for '\" .. (cmd.name .. (\"': \" .. err))\
\9\9assert(fn, _arg1)\
\9\9task.defer(fn)\
\9end, function(e)\
\9\9warn(\"[Havoc] Failed to run '\" .. (cmd.name .. (\"': \" .. tostring(e))))\
\9end)\
end)\
local function Misc()\
\9local _binding = useState({})\
\9local commands = _binding[1]\
\9local setCommands = _binding[2]\
\9local _binding_1 = useState(\"\")\
\9local search = _binding_1[1]\
\9local setSearch = _binding_1[2]\
\9local _binding_2 = useState(\"Loading...\")\
\9local status = _binding_2[1]\
\9local setStatus = _binding_2[2]\
\9useEffect(function()\
\9\9task.spawn(TS.async(function()\
\9\9\9TS.try(function()\
\9\9\9\9local raw = TS.await(http.get(GIST_URL))\
\9\9\9\9local parsed = HttpService:JSONDecode(raw)\
\9\9\9\9setCommands(parsed)\
\9\9\9\9setStatus(\"\")\
\9\9\9end, function(e)\
\9\9\9\9setStatus(\"Failed to load commands.\")\
\9\9\9\9warn(\"[Havoc] Misc tab error: \" .. tostring(e))\
\9\9\9end)\
\9\9end))\
\9end, {})\
\9local _arg0 = function(cmd)\
\9\9local _exp = string.lower(cmd.name)\
\9\9local _arg0_1 = string.lower(search)\
...
\9\9\9Size = UDim2.new(1, -24, 0, 36),\
\9\9\9Position = UDim2.new(0, 12, 0, 12),\
\9\9\9BackgroundColor3 = Color3.fromHex(\"#0D0D0D\"),\
\9\9\9BorderSizePixel = 0,\
\9\9}, {\
\9\9\9Roact.createElement(\"UICorner\", {\
\9\9\9\9CornerRadius = UDim.new(0, 8),\
...
\9\9\9\9Size = UDim2.new(1, -12, 1, 0),\
\9\9\9\9Position = UDim2.new(0, 12, 0, 0),\
\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9TextColor3 = Color3.fromHex(\"#ffffff\"),\
\9\9\9\9PlaceholderText = \"Search commands...\",\
\9\9\9\9PlaceholderColor3 = Color3.fromHex(\"#666666\"),\
\9\9\9\9TextSize = 14,\
\9\9\9\9Font = Enum.Font.Gotham,\
\9\9\9\9TextXAlignment = Enum.TextXAlignment.Left,\
\9\9\9\9ClearTextOnFocus = false,\
\9\9\9\9Text = search,\
\9\9\9\9[Roact.Change.Text] = function(rbx)\
\9\9\9\9\9return setSearch(rbx.Text)\
\9\9\9\9end,\
\9\9\9}),\
\9\9}),\
\9}\
\9local _length_1 = #_children\
\9local _child = status ~= \"\" and (Roact.createFragment({\
\9\9Status = Roact.createElement(\"TextLabel\", {\
\9\9\9Size = UDim2.new(1, -24, 0, 24),\
\9\9\9Position = UDim2.new(0, 12, 0, 56),\
\9\9\9BackgroundTransparency = 1,\
\9\9\9TextColor3 = Color3.fromHex(\"#666666\"),\
\9\9\9TextSize = 13,\
...
\9if _child then\
\9\9if _child.elements ~= nil or _child.props ~= nil and _child.component ~= nil then\
\9\9\9_children[_length_1 + 1] = _child\
\9\9else\
\9\9\9for _k, _v in ipairs(_child) do\
\9\9\9\9_children[_length_1 + _k] = _v\
\9\9\9end\
\9\9end\
\9end\
\9_length_1 = #_children\
\9local _arg0_1 = function(cmd, i)\
\9\9return Roact.createFragment({\
\9\9\9[cmd.name] = Roact.createElement(\"Frame\", {\
\9\9\9\9LayoutOrder = i,\
\9\9\9\9Size = UDim2.new(1, 0, 0, 48),\
\9\9\9\9BackgroundColor3 = Color3.fromHex(\"#111111\"),\
\9\9\9\9BorderSizePixel = 0,\
\9\9\9}, {\
\9\9\9\9Roact.createElement(\"UICorner\", {\
\9\9\9\9\9CornerRadius = UDim.new(0, 8),\
\9\9\9\9}),\
\9\9\9\9Name = Roact.createElement(\"TextLabel\", {\
\9\9\9\9\9Size = UDim2.new(1, -80, 0, 24),\
\9\9\9\9\9Position = UDim2.new(0, 12, 0, 6),\
\9\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9\9TextColor3 = Color3.fromHex(\"#ffffff\"),\
\9\9\9\9\9TextSize = 14,\
\9\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9\9Text = cmd.name,\
\9\9\9\9\9TextXAlignment = Enum.TextXAlignment.Left,\
\9\9\9\9}),\
\9\9\9\9Description = Roact.createElement(\"TextLabel\", {\
\9\9\9\9\9Size = UDim2.new(1, -80, 0, 18),\
\9\9\9\9\9Position = UDim2.new(0, 12, 0, 26),\
\9\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9\9TextColor3 = Color3.fromHex(\"#888888\"),\
\9\9\9\9\9TextSize = 12,\
\9\9\9\9\9Font = Enum.Font.Gotham,\
\9\9\9\9\9Text = cmd.description,\
\9\9\9\9\9TextXAlignment = Enum.TextXAlignment.Left,\
\9\9\9\9}),\
\9\9\9\9RunButton = Roact.createElement(\"TextButton\", {\
\9\9\9\9\9Size = UDim2.new(0, 60, 0, 28),\
\9\9\9\9\9Position = UDim2.new(1, -70, 0.5, -14),\
\9\9\9\9\9BackgroundColor3 = Color3.fromHex(\"#CC2929\"),\
\9\9\9\9\9BorderSizePixel = 0,\
\9\9\9\9\9TextColor3 = Color3.fromHex(\"#ffffff\"),\
\9\9\9\9\9TextSize = 13,\
\9\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9\9Text = \"Run\",\
\9\9\9\9\9[Roact.Event.MouseButton1Click] = function()\
\9\9\9\9\9\9return task.spawn(function()\
\9\9\9\9\9\9\9return runCommand(cmd)\
\9\9\9\9\9\9end)\
\9\9\9\9\9end,\
\9\9\9\9}, {\
\9\9\9\9\9Roact.createElement(\"UICorner\", {\
\9\9\9\9\9\9CornerRadius = UDim.new(0, 6),\
\9\9\9\9\9}),\
\9\9\9\9}),\
\9\9\9}),\
\9\9})\
\9end\
\9-- ▼ ReadonlyArray.map ▼\
\9local _newValue_1 = table.create(#filtered)\
\9for _k, _v in ipairs(filtered) do\
\9\9_newValue_1[_k] = _arg0_1(_v, _k - 1, filtered)\
\9end\
\9-- ▲ ReadonlyArray.map ▲\
\9local _attributes_1 = {\
\9\9Size = UDim2.new(1, -24, 1, -68),\
\9\9Position = UDim2.new(0, 12, 0, 56),\
\9\9BackgroundTransparency = 1,\
\9\9BorderSizePixel = 0,\
\9\9ScrollBarThickness = 4,\
\9\9ScrollBarImageColor3 = Color3.fromHex(\"#CC2929\"),\
\9\9CanvasSize = UDim2.new(0, 0, 0, #filtered * 56),\
...
\9end\
\9_children.List = Roact.createElement(\"ScrollingFrame\", _attributes_1, _children_1)\
\9return Roact.createElement(Canvas, _attributes, _children)\
end\
...
local Misc = TS.import(script, script.Parent, \"Misc\").default\
...
\9\9return isVisible\
\9end)\
\9local isMiscVisible = useDelayedUpdate(currentPage == DashboardPage.Misc, 2000, function(isVisible)\
\9\9return isVisible\
\9end)\
\9local _children = {\
...
\9end\
\9_length = #_children\
\9local _child_1 = isMiscVisible and Roact.createFragment({\
...
newModule("Promise", "ModuleScript", "hvcorca.include.Promise", "hvcorca.include", function () local fn = assert(loadstring("--[[\
...
newInstance("@rbxts", "Folder", "hvcorca.include.node_modules.@rbxts", "hvcorca.include.node_modules")

newInstance("compiler-types", "Folder", "hvcorca.include.node_modules.@rbxts.compiler-types", "hvcorca.include.node_modules.@rbxts")

newInstance("types", "Folder", "hvcorca.include.node_modules.@rbxts.compiler-types.types", "hvcorca.include.node_modules.@rbxts.compiler-types")

newInstance("flipper", "Folder", "hvcorca.include.node_modules.@rbxts.flipper", "hvcorca.include.node_modules.@rbxts")

newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src", "hvcorca.include.node_modules.@rbxts.flipper", function () local fn = assert(loadstring("local Flipper = {\
...
\
return Flipper", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src")) return fn() end)

newModule("BaseMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.BaseMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () local fn = assert(loadstring("local RunService = game:GetService(\"RunService\")\
\
...
\
return Instant", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src.Instant")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Instant")) return fn() end)

newModule("Linear", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.Linear", "hvcorca.include.node_modules.@rbxts.flipper.src", function () local fn = assert(loadstring("local Linear = {}\
...
\
return Linear", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src.Linear")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Linear")) return fn() end)

newModule("Signal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.Signal", "hvcorca.include.node_modules.@rbxts.flipper.src", function () local fn = assert(loadstring("local Connection = {}\
...
\
return Signal", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src.Signal")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Signal")) return fn() end)

newModule("SingleMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.SingleMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () local fn = assert(loadstring("local BaseMotor = require(script.Parent.BaseMotor)\
\
...
\
return Spring", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src.Spring")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.Spring")) return fn() end)

newModule("isMotor", "ModuleScript", "hvcorca.include.node_modules.@rbxts.flipper.src.isMotor", "hvcorca.include.node_modules.@rbxts.flipper.src", function () local fn = assert(loadstring("local function isMotor(value)\
...
\
return isMotor", '@'.."hvcorca.include.node_modules.@rbxts.flipper.src.isMotor")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.flipper.src.isMotor")) return fn() end)

newInstance("typings", "Folder", "hvcorca.include.node_modules.@rbxts.flipper.typings", "hvcorca.include.node_modules.@rbxts.flipper")

newModule("make", "ModuleScript", "hvcorca.include.node_modules.@rbxts.make", "hvcorca.include.node_modules.@rbxts", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
--[[\
\9*\
...
\
return Object\
", '@'.."hvcorca.include.node_modules.@rbxts.object-utils")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.object-utils")) return fn() end)

newInstance("roact", "Folder", "hvcorca.include.node_modules.@rbxts.roact", "hvcorca.include.node_modules.@rbxts")

newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src", "hvcorca.include.node_modules.@rbxts.roact", function () local fn = assert(loadstring("--[[\
...
\
return Roact", '@'.."hvcorca.include.node_modules.@rbxts.roact.src")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src")) return fn() end)

newModule("Binding", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Binding", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local createSignal = require(script.Parent.createSignal)\
...
\
return BindingInternalApi", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Binding")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Binding")) return fn() end)

newModule("Component", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Component", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local assign = require(script.Parent.assign)\
...
\
return Component", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Component")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Component")) return fn() end)

newModule("ComponentLifecyclePhase", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
...
\
return ComponentLifecyclePhase", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ComponentLifecyclePhase")) return fn() end)

newModule("Config", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Config", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Config", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Config")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Config")) return fn() end)

newModule("ElementKind", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ElementKind", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return ElementKind", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.ElementKind")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ElementKind")) return fn() end)

newModule("ElementUtils", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.ElementUtils", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Type = require(script.Parent.Type)\
local Symbol = require(script.Parent.Symbol)\
\
local function noop()\
\9return nil\
...
\
return ElementUtils", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.ElementUtils")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.ElementUtils")) return fn() end)

newModule("GlobalConfig", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.GlobalConfig", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
\9Exposes a single instance of a configuration as Roact's GlobalConfig.\
]]\
\
local Config = require(script.Parent.Config)\
\
return Config.new()", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.GlobalConfig")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.GlobalConfig")) return fn() end)

newModule("Logging", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Logging", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Logging", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Logging")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Logging")) return fn() end)

newModule("None", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.None", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
\
-- Marker used to specify that the value is nothing, because nil cannot be\
-- stored in tables.\
local None = Symbol.named(\"None\")\
\
return None", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.None")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.None")) return fn() end)

newModule("NoopRenderer", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.NoopRenderer", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return NoopRenderer", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.NoopRenderer")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.NoopRenderer")) return fn() end)

newModule("Portal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Portal", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
\
local Portal = Symbol.named(\"Portal\")\
\
return Portal", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Portal")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Portal")) return fn() end)

newInstance("PropMarkers", "Folder", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers", "hvcorca.include.node_modules.@rbxts.roact.src")

newModule("Change", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Change", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers", function () local fn = assert(loadstring("--[[\
...
\
return Children", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Children")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Children")) return fn() end)

newModule("Event", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Event", "hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers", function () local fn = assert(loadstring("--[[\
...
\
return Ref", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Ref")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PropMarkers.Ref")) return fn() end)

newModule("PureComponent", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.PureComponent", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return PureComponent", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.PureComponent")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.PureComponent")) return fn() end)

newModule("RobloxRenderer", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.RobloxRenderer", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return SingleEventManager", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.SingleEventManager")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.SingleEventManager")) return fn() end)

newModule("Symbol", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Symbol", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Symbol", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Symbol")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Symbol")) return fn() end)

newModule("Type", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.Type", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return Type", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.Type")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.Type")) return fn() end)

newModule("assertDeepEqual", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.assertDeepEqual", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return assertDeepEqual", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.assertDeepEqual")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.assertDeepEqual")) return fn() end)

newModule("assign", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.assign", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local None = require(script.Parent.None)\
\
--[[\
...
\
return assign", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.assign")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.assign")) return fn() end)

newModule("createContext", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createContext", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
...
\
return createElement", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.createElement")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createElement")) return fn() end)

newModule("createFragment", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createFragment", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local ElementKind = require(script.Parent.ElementKind)\
local Type = require(script.Parent.Type)\
\
...
\
return createFragment", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.createFragment")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createFragment")) return fn() end)

newModule("createReconciler", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createReconciler", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local Type = require(script.Parent.Type)\
local ElementKind = require(script.Parent.ElementKind)\
...
\
return createReconcilerCompat", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.createReconcilerCompat")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createReconcilerCompat")) return fn() end)

newModule("createRef", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createRef", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createRef", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.createRef")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createRef")) return fn() end)

newModule("createSignal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.createSignal", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return createSpy", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.createSpy")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.createSpy")) return fn() end)

newModule("forwardRef", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.forwardRef", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local assign = require(script.Parent.assign)\
...
\
return forwardRef", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.forwardRef")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.forwardRef")) return fn() end)

newModule("getDefaultInstanceProperty", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return getDefaultInstanceProperty", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.getDefaultInstanceProperty")) return fn() end)

newModule("internalAssert", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.internalAssert", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local function internalAssert(condition, message)\
\9if not condition then\
\9\9error(message .. \" (This is probably a bug in Roact!)\", 3)\
\9end\
end\
\
return internalAssert", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.internalAssert")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.internalAssert")) return fn() end)

newModule("invalidSetStateMessages", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.invalidSetStateMessages", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return invalidSetStateMessages", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.invalidSetStateMessages")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.invalidSetStateMessages")) return fn() end)

newModule("oneChild", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.oneChild", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("--[[\
...
\
return oneChild", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.oneChild")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.oneChild")) return fn() end)

newModule("strict", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact.src.strict", "hvcorca.include.node_modules.@rbxts.roact.src", function () local fn = assert(loadstring("local function strict(t, name)\
...
\
return strict", '@'.."hvcorca.include.node_modules.@rbxts.roact.src.strict")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.roact.src.strict")) return fn() end)

newInstance("roact-hooked", "Folder", "hvcorca.include.node_modules.@rbxts.roact-hooked", "hvcorca.include.node_modules.@rbxts")

newModule("out", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-hooked.out", "hvcorca.include.node_modules.@rbxts.roact-hooked", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = _G[script]\
local exports = {}\
...
newModule("are-deps-equal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-hooked.out.utils.are-deps-equal", "hvcorca.include.node_modules.@rbxts.roact-hooked.out.utils", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
newModule("out", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
local exports = {}\
...
newModule("context", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.components.context", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
...
newModule("shallow-equal", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.helpers.shallow-equal", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.helpers", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
newModule("use-dispatch", "ModuleScript", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.hooks.use-dispatch", "hvcorca.include.node_modules.@rbxts.roact-rodux-hooked.out.hooks", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
local TS = _G[script]\
...
newModule("src", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src", "hvcorca.include.node_modules.@rbxts.rodux", function () local fn = assert(loadstring("local Store = require(script.Store)\
...
\
return Signal", '@'.."hvcorca.include.node_modules.@rbxts.rodux.src.Signal")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.rodux.src.Signal")) return fn() end)

newModule("Store", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src.Store", "hvcorca.include.node_modules.@rbxts.rodux.src", function () local fn = assert(loadstring("local RunService = game:GetService(\"RunService\")\
\
local Signal = require(script.Parent.Signal)\
...
\
return prettyPrint", '@'.."hvcorca.include.node_modules.@rbxts.rodux.src.prettyPrint")) setfenv(fn, newEnv("hvcorca.include.node_modules.@rbxts.rodux.src.prettyPrint")) return fn() end)

newModule("thunkMiddleware", "ModuleScript", "hvcorca.include.node_modules.@rbxts.rodux.src.thunkMiddleware", "hvcorca.include.node_modules.@rbxts.rodux.src", function () local fn = assert(loadstring("--[[\
...
newInstance("include", "Folder", "hvcorca.include.node_modules.@rbxts.types.include", "hvcorca.include.node_modules.@rbxts.types")

newInstance("generated", "Folder", "hvcorca.include.node_modules.@rbxts.types.include.generated", "hvcorca.include.node_modules.@rbxts.types.include")
